...
| **Python 环境** | 一键部署 Python 3.12 + pygame/numpy 等常用库，官方安装器 + 国内镜像加速 |
...
**Q: Python 环境安装失败？**
A: 程序使用官方 Python 安装程序（python.org），通过 UAC 提权以管理员身份运行。安装过程实时显示进度。
在设置中检查镜像源配置，国内用户推荐清华 Tuna 镜像。安装是否成功可以通过重新打开 Python 环境页查看状态确认。
